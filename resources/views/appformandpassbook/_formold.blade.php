<div class="col-md-12" style="background-color: #EAEAEA">
    ...
    <div class="form-group col-md-6" id="form-date-error">
        ...
        <div class="col-md-6">
            {!! Form::date("date", null,["class"=>"form-control ","id"=>"focus"]) !!}
            <span id="date-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group col-md-6" id="form-app_form-error">
        {!! Form::label("app_form","Entry Form Fee",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("app_form",50 ,["class"=>"form-control ","id"=>"focus", "readonly"=>"true"]) !!}
            <span id="app_form-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group col-md-6" id="form-passbook-error">
        {!! Form::label("passbook","Passbook Fee",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("passbook",20,["class"=>"form-control ","id"=>"focus", "readonly"=>"true"]) !!}
            <span id="passbook-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group col-md-6" id="form-saving_amount-error">
        {!! Form::label("saving_amount","Saving Amount",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("saving_amount",100,["class"=>"form-control ","id"=>"focus", "readonly"=>"true"]) !!}
            <span id="saving_amount-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group col-md-6" id="form-share_number-error">
        {!! Form::label("share_number","No of Shares",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6" onChange= "updatePrice()">
            {!! Form::number("share_number",null,["class"=>"form-control ","id"=>"share_number"]) !!}
            <span id="share_number-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group col-md-6" id="form-share_amount-error">
        {!! Form::label("share_amount","Share Amount",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("share_amount",null,["class"=>"form-control ","id"=>"share_amount", "readonly"=>"true"]) !!}
            <span id="share_amount-error" class="help-block"></span>
        </div>
    </div>
    
    <div class="form-group col-md-6" id="form-name-error">
        {!! Form::label("name","DPS Duration",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("name",null,["class"=>"form-control ","id"=>"focus"]) !!}
            <span id="name-error" class="help-block"></span>
        </div>
    </div>
   
    <div class="form-group col-md-6" id="form-unitprice-error">
        {!! Form::label("unitprice","DPS Amount",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("unitprice",null,["class"=>"form-control ","id"=>"focus"]) !!}
