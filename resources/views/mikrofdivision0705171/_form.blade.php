<div class="col-md-12" style="background-color: #EAEAEA">
    <div class="borderportion">
        ...
        <div class="form-group required col-md-6" id="form-DivisionOfficeNameBangla-error">
            {!! Form::label("DivisionOfficeNameBangla","Office Name in Bangla",["class"=>"control-label test col-md-3"]) !!}
            <div class="col-md-6">
    ...
    <div class="borderportion">
        ...
        <div class="form-group required col-md-6" id="form-DivisionOfficeUnionId-error">
            ...
            <div class="col-md-6">
                {!! Form::select("DivisionOfficeUnionId",$ThanaInfo,null,["class"=>"form-control DivisionOfficeUnionId required","id"=>"DivisionOfficeUnionId"]) !!}
        ...
        <div class="form-group required col-md-6" id="form-DomainId-error">
            {!! Form::label("DomainId","Domain",["class"=>"control-label test col-md-3"]) !!}
            <div class="col-md-6">
                {!! Form::select("DomainId",$DomainInfo,null,["class"=>"form-control DomainId required","id"=>"DomainId"]) !!}
                <span id="DomainId-error" class="help-block"></span>
            </div>
        </div>
