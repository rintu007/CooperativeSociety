@if(Auth::guest())
@else
<h1 class="page-header">Member Approved List
    <!-- <div class="pull-left">
        <a href="javascript:ajaxLoad('memberapprove/create')" class="btn btn-primary pull-left"><i
    ...
    <div class="pull-right">
        <a href="javascript:ajaxLoad('memberapprove/memberapproved')" class="btn btn-primary pull-right"><i
                    class="glyphicon glyphicon-ok"></i> memberapproved</a>
    </div> -->
</h1>
        ...
        <tr id="row{{$i}}">
            ...
            <td style="text-align: center">
               <!--  <a class="btn btn-primary btn-xs" title="view"
                   href="javascript:ajaxLoad('memberapprove/update1/{{$memberapprove->id}}')">
                    <i class="glyphicon glyphicon-view"></i> view</a> -->
                <button onclick="shishirApproval({{$i}})" type="submit" >cancel</button>
...
<div class="col-md-6 col-md-push-3">
        <a href="javascript:ajaxLoad('memberapprove/list')" class="btn btn-danger"><i
